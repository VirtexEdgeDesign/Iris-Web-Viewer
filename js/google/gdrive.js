...
var clientId =
  '629606533840-1j5m58o3krsdkno8hiamd763opce78ia.apps.googleusercontent.com';
...
function pickerCallback(data) {
  if (data.action == google.picker.Action.PICKED) {
    ...
    document.getElementById('modal_GDrivePicker-prgrsbar').style.width =
      0 + '%';

    document.getElementById('modal_GDrivePicker-name').innerHTML =
      'Requesting File: ' + data.docs[0].name;
        ...
        callback: function(responsejs, responsetxt) {
          ...
          xhr.onload = function() {
            ...
            if (currentFileIndex == numOfFilesToGet) {
              ...
              document.getElementById('modal_GDrivePicker').style.display =
                'none';
