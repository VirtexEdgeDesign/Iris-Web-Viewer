function vxModel(file) {
  ...
  if (file.size > 1000000) this.fileInfo.size = file.size / 1000000 + ' Mb';
  else this.fileInfo.size = file.size / 1000 + ' Kb';
...
vxModel.prototype.addImportNotes = function() {
  if (this.NotesAdded == false) {
    ...
    for (var key in this.modelLoadNotes) {
      ...
      AddTreeNode(
        this.modelImportResults + '_' + count,
        pre + note.title,
        nodeToAdd,
        imgKey
      );
...
vxModel.prototype.initTreeNodes = function() {
  if (this.IsTreeInit == false) {
    ...
    AddTreeNode(
      this.modelFileNode + '_name',
      'File Name: ' + this.fileInfo.fileName,
      this.modelFileNode,
      'document_import'
    );
    AddTreeNode(
      this.modelFileNode + '_type',
      'Type: ' + this.fileInfo.type,
      this.modelFileNode + '_name',
      'document_info'
    );
    AddTreeNode(
      this.modelFileNode + '_format',
      'Format: ' + this.fileInfo.format,
      this.modelFileNode + '_name',
      'file_bin'
    );
    AddTreeNode(
      this.modelFileNode + '_size',
    ...
    AddTreeNode(
      'node_' + this.Name + '_center',
      center,
      this.modelGeomNod,
      'center'
    );
    AddTreeNode(
      'node_' + this.Name + '_numOfVerts',
      this.numOfModelVerts,
      this.modelGeomNod,
      'axis'
    );
    AddTreeNode(
      'node_' + this.Name + '_numOfFcs',
      this.numOfModelFcs,
      this.modelGeomNod,
      'plane'
    );
    ...
    for (var key in this.Meshes) {
      ...
      AddTreeNode(
        'node_' + this.Name + '_' + mesh.Name + '_center',
        meshCenter,
        geomNod,
        'center'
      );
      AddTreeNode(
        'node_' + this.Name + '_' + mesh.Name + '_numOfVerts',
        numOfVerts,
        geomNod,
        'axis'
      );
      AddTreeNode(
        'node_' + this.Name + '_' + mesh.Name + '_numOfFcs',
        numOfFcs,
        geomNod,
        'plane'
      );
      ...
      for (var key in mesh.Materials) {
        ...
        var nodeID_MtlInfo =
          'node_' + this.Name + '_' + mesh.Name + '_' + material.Name;
        AddTreeNode(
          nodeID_MtlInfo,
        ...
        // Ambient
        AddTreeNode(
          nodeID_Colors + '_ambient',
          'Ambient',
          nodeID_Colors,
          'node_color_info'
        );
        AddColorTreeNode(
          nodeID_Colors + '_ambient_col',
          'Colour',
          material.AmbientColour,
          nodeID_Colors + '_ambient'
        );
        AddTreeNode(
          nodeID_Colors + '_ambient_factor',
          'Intensity: 1',
          nodeID_Colors + '_ambient',
          'hash'
        );
        ...
        // Diffuse
        AddTreeNode(
          nodeID_Colors + '_diffuse',
          'Diffuse',
          nodeID_Colors,
          'node_color_info'
        );
        AddColorTreeNode(
          nodeID_Colors + '_diffuse_col',
          'Colour',
          material.DiffuseColour,
          nodeID_Colors + '_diffuse'
        );
        AddTreeNode(
          nodeID_Colors + '_diffuse_factor',
          'Intensity: 1',
          nodeID_Colors + '_diffuse',
          'hash'
        );
        ...
        // Emissive
        AddTreeNode(
          nodeID_Colors + '_emissive',
          'Emissive',
          nodeID_Colors,
          'node_color_info'
        );
        AddColorTreeNode(
          nodeID_Colors + '_emissive_col',
          'Colour',
          material.EmissiveColour,
          nodeID_Colors + '_emissive'
        );
        AddTreeNode(
          nodeID_Colors + '_emissive_factor',
          'Intensity: 1',
          nodeID_Colors + '_emissive',
          'hash'
        );
        ...
        // Specular
        AddTreeNode(
          nodeID_Colors + '_specular',
          'Specular',
          nodeID_Colors,
          'node_color_info'
        );
        AddColorTreeNode(
          nodeID_Colors + '_specular_col',
          'Colour',
          material.SpecularColour,
          nodeID_Colors + '_specular'
        );
        AddTreeNode(
          nodeID_Colors + '_specular_factor',
          'Intensity: 1',
          nodeID_Colors + '_specular',
          'hash'
        );
        AddTreeNode(
          nodeID_Colors + '_specular_power',
        ...
        if (material.DiffuseTexture.name !== '') {
          ...
          AddTreeNode(
            nodeID_Textures + '_textures_none',
            '<none>',
            nodeID_Textures,
            'error'
          );
